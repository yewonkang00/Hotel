							...
							<td class="today">
								<div class="date">
									...
									<c:when test="${chkDate eq '1'}">
										...
										<c:otherwise><input type="button" value="예약" class="submit-btn" onClick="reservation('${roomNo}','${curDate}');">
										</c:otherwise>
									</c:choose>	
								</div>
								<div>
					...
					<div class="date">
						${dateList.date}<br><br><br>
									...
									<c:when test="${chkDate eq '1'}">
										...
										<c:otherwise><input type="button" value="예약" class="submit-btn" onClick="reservation('${roomNo}','${curDate}');"></c:otherwise>
									</c:choose>	
					</div>
					<div>
